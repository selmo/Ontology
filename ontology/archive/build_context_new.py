#!/usr/bin/env python3
"""
enhanced_data_new.py의 상세 정보를 포함하여 context.json 재생성 (data.go.kr 기반)
"""
...
def parse_context_txt(filepath: str):
    ...
    data = {
        "metadata": {
            ...
            "description": "MC 분류·용어 통합 체계 (data.go.kr 기반 재구성)"
        },
        "id_schema": {
...
if __name__ == '__main__':
    input_file = 'context_new.txt'
    output_file = 'context_new.json'
    ...
    for domain in data['domains']:
        counts = count_relations(domain['terms'])
